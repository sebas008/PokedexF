...
import com.example.pokedexf.Adapter.PokemonEvolutionAdapter;
import com.example.pokedexf.Adapter.PokemonTypeAdapter;
...
public class PokemonDetail extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recycler_prev_evolution = (RecyclerView) itemView.findViewById(R.id.recycler_next_evolution);
    ...
    private void setDetailPokemon(Pokemon pokemon) {
        ...
        PokemonEvolutionAdapter prevEvolutionAdapter = new PokemonEvolutionAdapter(getActivity(),pokemon.getPre_evolution());
